...
public class Commands {
    ...
    public Commands(CommandExecutor executor, Server server, Routestorage routestorage, CommandData commandData, DataBaseManager dataBaseManager) {
...
//        executor.registerCommand("help", new HelpCommand(server));
//        executor.registerCommand("show", new ShowCommand(server, routestorage));
//        executor.registerCommand("info", new InfoCommand(server, routestorage));
//        executor.registerCommand("info_objects", new InfoObjectsCommand(server));
//        executor.registerCommand("clear", new ClearCommand(server, routestorage, dataBaseManager, commandData));
//        executor.registerCommand("insert", new InsertCommand(server,routestorage, dataBaseManager, null));
//        executor.registerCommand("update_id", new UpdateIdCommand(server, routestorage, commandData, dataBaseManager));
//        executor.registerCommand("remove_key", new RemoveKeyCommand(server, routestorage, commandData, dataBaseManager));
//        executor.registerCommand("remove_lower", new RemoveLowerCommand(server,routestorage,commandData, dataBaseManager));
//        executor.registerCommand("remove_greater", new RemoveGreaterCommand(server,routestorage,commandData, dataBaseManager));
//        executor.registerCommand("remove_lower_key", new RemoveLowerKeyCommand(server,routestorage,commandData, dataBaseManager));
//        executor.registerCommand("filter_by_distance", new FilterByDistanceCommand(server,routestorage,commandData));
//        executor.registerCommand("filter_starts_with_name", new FilterStartsWithNameCommand(server,routestorage, commandData));
//        executor.registerCommand("count_greater_than_distance", new CountGreaterThanDistanceCommand(server,routestorage,commandData));
//    }
