...
public class Commands {
    ...
    public void registerAllCommands() {
        ...
        executor.registerCommand("update_id", new UpdateIdCommand(commandData, null));
        ...
        executor.registerCommand("remove_lower_key", new RemoveLowerKeyCommand(commandData, 0));
