...
import collectionCommands.RemoveGreaterCommand;
import collectionCommands.RemoveLowerCommand;
...
public class RemoveLowerForm extends javax.swing.JFrame {
    ...
    public RemoveLowerForm(AppForm appForm, Client client) {
    ...
    private void ButtonConfirmActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        distance = (float) DistanceCalculator.calculateDistance(tempX1, tempY1, tempX2, tempY2);


        if (routename == null || routename.trim().isEmpty()) {
            JOptionPane.showMessageDialog(this, "Route name не может быть пустым", "Ошибка", JOptionPane.ERROR_MESSAGE);
        }
