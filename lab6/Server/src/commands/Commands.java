...
public class Commands {
    ...
    public Commands(CommandExecutor executor, Server server, Routestorage routestorage, CommandData commandData) {
    ...
    public void registerAllCommands() {
        ...
        executor.registerCommand("clear", new ClearCommand(server, routestorage));
        executor.registerCommand("insert", new InsertCommand(server,routestorage, commandData));
        executor.registerCommand("update_id", new UpdateIdCommand(server, routestorage, commandData));
        executor.registerCommand("remove_key", new RemoveKeyCommand(server, routestorage, commandData));
        executor.registerCommand("remove_lower", new RemoveLowerCommand(server,routestorage,commandData));
        executor.registerCommand("remove_greater", new RemoveGreaterCommand(server,routestorage,commandData));
        executor.registerCommand("remove_lower_key", new RemoveLowerKeyCommand(server,routestorage,commandData));
